...
const KPI = {
  ...
  rows: () => [
    ['Year', 'Month', 'PLANT', 'Shipped Cartons #', 'Deliveries', ' Shipped $',
     ...
     'OTIF', 'OTIF %'],
    [2026, 'JAN',   'Toronto', 1, 200, 1000000, 15, 0, 2, 10000, 0.01,   0.01, 180, 0.9],
    [2026, 'FEB',   'Toronto', 1, 200, 1000000,  7, 8, 4,  5000, 0.005,  0.01, 190, 0.95],
    [2026, 'March', 'Toronto', 1, 200, 2000000, 16, 0, 6,  5000, 0.0025, 0.01, 196, 0.98],
    [2026, 'Apr',   'Toronto', 1, 200, 1000000, 12, 1, 3,  1000, 0.001,  0.01, 198, 0.99],
  ],
};
